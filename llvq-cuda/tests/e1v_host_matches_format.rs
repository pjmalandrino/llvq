...
fn the_tables_are_the_records_reinterpreted() {
    ...
    assert_eq!(words.len(), recs.len() * 27, "108 octets = 27 mots par record");
    ...
    assert_eq!(bytes, raw, "les mots ne sont pas les records");
}

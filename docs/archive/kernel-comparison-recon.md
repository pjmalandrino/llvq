...
> 2026-08-10). `docs/archive/mail-qualcomm-draft.md` en garde le texte, et il pose déjà
...
`docs/archive/portage-noyau-cuda.md:721` et `docs/archive/experience-mesure.md:229-233`
...
- **`docs/data/jobs.csv` s'arrête au 2026-08-08 et ne contient pas le 14B.**
  ...
  ajoutés (`docs/archive/reprise-14b-2026-08-09.md:23`). Les quatre sites et

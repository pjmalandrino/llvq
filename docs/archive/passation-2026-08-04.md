...
2026-08-05 à **2,03× [2,03–2,10]**, médiane du rapport formé round par round —
...
[`docs/archive/portage-noyau-cuda.md`](portage-noyau-cuda.md)** : le noyau Metal
...
[`docs/archive/experience-mesure.md`](experience-mesure.md). Trois bras : notre LLVQ
...
|---|---|
| [`docs/archive/portage-noyau-cuda.md`](portage-noyau-cuda.md) | **La spécification du portage.** À lire en premier |
| [`docs/fiche-4b.md`](../fiche-4b.md) | La vérité terrain sur le modèle publié : chaque chiffre avec sa provenance et son statut |
| [`docs/archive/experience-mesure.md`](experience-mesure.md) | La campagne de mesure, prête à lancer |
| [`docs/archive/plan-de-test-v2-cuda.md`](plan-de-test-v2-cuda.md) | Le protocole détaillé dont le précédent est le résumé exécutable |
| [`docs/archive/audit-publication-2026-08-03.md`](audit-publication-2026-08-03.md) | L'audit qui a déclenché les corrections |

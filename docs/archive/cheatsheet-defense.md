...
| Débit bout en bout, L40S, mêmes octets | 🕳️ *les points uniques d'époque (48,7 · 88,4-88,5 · ×2,03 · ×1,12) sont remplacés depuis B2 et la vague 2 :* dense **43,6 [43,5–43,6]** · fusé f16 **48,3 [48,1–48,3] (×1,11 [1,11–1,11] à tête identique — LE rapport du noyau)** · servi B2 (`ROT_SHARE=0/FUSE=0`) **87,0 [86,8–87,0] (×2,00, dont le `lm_head` de NOTRE bras dense)** · **config servie v1 (gel 2026-08-31, `ROT_SHARE=1/FUSE=1`) : 100,6 [99,9–100,7] dans 2,57 Go** |

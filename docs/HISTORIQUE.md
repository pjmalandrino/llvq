...
The project's chronological thread, one entry per period, from 2026-07-24 to 2026-09-13, with ten entries owed between 2026-09-07 and 2026-09-12. The current state is in ETAT.md, the lab rules in METHODE.md, shipped with this file; until they are in `docs/`, [CLAUDE.md](../CLAUDE.md) is authoritative.

...
- en tirer la moindre vitesse aujourd'hui : le noyau fusé **n'est pas branché** dans `bin/run` (§6.5) ;
...
### 6.10 Pourquoi le noyau n'est pas branché — l'obstacle n'est pas de la plomberie

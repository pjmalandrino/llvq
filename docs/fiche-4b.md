...
> 🕳️ **Les débits de ce paragraphe ont DEUX générations de retard (annoté le
> 2026-09-01).** « 48,7 », « 88,4-88,5 dans 2,60 Go », « ×2,03 » et « ×1,12 »
> sont des points uniques d'époque : B2 (2026-08-18) les a remplacés par des
> médianes à plage — **87,0 [86,8–87,0] tok/s dans 2,56 Go, ×2,00
> [1,99–2,00], ×1,11 [1,11–1,11] à tête identique** — et depuis le
> **2026-08-31 (vague 2)** la config servie v1 est la FUSÉE
> (`ROT_SHARE=1/FUSE=1`) : **100,6 [99,9–100,7] tok/s dans 2,57 Go** au 4B
...
> Le raisonnement du paragraphe (les deux formulations, le lm_head handicapé)
> reste juste — seuls les nombres ont vieilli.

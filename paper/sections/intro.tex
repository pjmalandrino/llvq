...
throughput, and one measured dead end (3.59 bits per weight, compute-bound)
that maps the floor. We also attribute what the kernel is actually waiting
on, with an instrumented job rather than an assertion.

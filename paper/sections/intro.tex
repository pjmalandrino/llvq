...
place a deployed 4-bit kernel on the same axis in the same process: it
converts 88\% of its byte advantage into time against our 65\%, locating
the remaining work in the decode rather than the format.
